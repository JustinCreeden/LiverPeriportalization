...
pca_all_1_2_text = ggplot(coords, aes(x=PC1, y=PC2, label=time, color=dose)) +
  ...
  labs(x = str_c("PC1 (", explained[1], "%)"),
       ...
       color = "Treatment") +
  my_theme(grid = "no") +
  scale_color_manual(values = rwth_color(c("orange", "petrol", "red")), 
...
volcano_plot_ccl4 = limma_result %>%
  ...
  my_theme(grid = "y") +
  scale_color_manual(values = rwth_color(c("green", "blue", "black50"))) +
...
leading_edge_hmap = pheatmap(
  ...
  annotation_colors = list(Zonation = c(Pericentral = rwth_color("violet"),
                                        Periportal = rwth_color("turquoise")))) %>%
  as.ggplot()
...
# tab$grobs[24][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[25][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[26][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[27][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[28][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[29][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[30][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[31][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[32][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[33][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[34][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[35][[1]][["gp"]] = gpar(col = rwth_color("violet"))
tab$grobs[36][[1]][["gp"]] = gpar(col = rwth_color("turquoise"))
tab$grobs[37][[1]][["gp"]] = gpar(col = rwth_color("turquoise"))
tab$grobs[38][[1]][["gp"]] = gpar(col = rwth_color("turquoise"))
tab$grobs[39][[1]][["gp"]] = gpar(col = rwth_color("turquoise"))
tab$grobs[40][[1]][["gp"]] = gpar(col = rwth_color("turquoise"))

# make p italic
tab$grobs[4][[1]][["gp"]] = gpar(fontface = 4L)

# color KEGG pathway
tab$grobs[48][[1]][["gp"]] = gpar(col = rwth_color("maygreen"))
tab$grobs[50][[1]][["gp"]] = gpar(col = rwth_color("maygreen"))

# color mf
tab$grobs[43][[1]][["gp"]] = gpar(col = rwth_color("orange"))

# color bp
tab$grobs[41][[1]][["gp"]] = gpar(col = rwth_color("red"))
tab$grobs[44][[1]][["gp"]] = gpar(col = rwth_color("red"))
tab$grobs[45][[1]][["gp"]] = gpar(col = rwth_color("red"))
tab$grobs[46][[1]][["gp"]] = gpar(col = rwth_color("red"))
tab$grobs[47][[1]][["gp"]] = gpar(col = rwth_color("red"))
tab$grobs[49][[1]][["gp"]] = gpar(col = rwth_color("red"))
tab$grobs[52][[1]][["gp"]] = gpar(col = rwth_color("red"))
tab$grobs[53][[1]][["gp"]] = gpar(col = rwth_color("red"))
tab$grobs[54][[1]][["gp"]] = gpar(col = rwth_color("red"))

# color tf
tab$grobs[42][[1]][["gp"]] = gpar(col = rwth_color("purple"))
tab$grobs[51][[1]][["gp"]] = gpar(col = rwth_color("purple"))
tab$grobs[55][[1]][["gp"]] = gpar(col = rwth_color("purple"))
tab$grobs[56][[1]][["gp"]] = gpar(col = rwth_color("purple"))
...
legend_plot = tibble(source = factor(c("Molecular function (GO)", 
  ...
  # geom_text(size=4) +
  scale_color_manual(values = rwth_color(c("red", "orange", "maygreen", 
                                           "purple"))) +
